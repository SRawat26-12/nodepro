...
const InsertProduct=()=>{
    ...
    const handleSubmit=async(e)=>{
      ...
      formData.append('upload_preset', 'fooddel');
      formData.append('cloud_name', 'duhkbin2x');
      const response = await axios.post('https://api.cloudinary.com/v1_1/duhkbin2x/image/upload', formData);
