...
import ban1 from "../images/b1.jpeg";
import ban2 from "../images/b2.webp";
import ban3 from "../images/b3.jpeg";
...
const navigate= useNavigate();
  ...
  const ans=mydata.map((key)=>{
    return(
      <>
        <Card style={{ width: '18rem', marginTop:'20px',borderRadius:"40px" }}>
    ...
    return(
        <>
           ...
           <Carousel>
      <Carousel.Item>
          <img src={ban1} width="100%" height="350" />
        <Carousel.Caption>
      ...
      <Carousel.Item>
      <img src={ban2} width="100%" height="350" />
        <Carousel.Caption>
      ...
      <Carousel.Item>
      <img src={ban3} width="100%" height="350" />
        <Carousel.Caption>
          ...
          <h1 align="center"> Our Food items</h1>
        <div id="carddata">
        {ans}
        </div>
